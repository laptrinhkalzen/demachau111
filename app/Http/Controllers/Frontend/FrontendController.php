...
class FrontendController extends Controller {
    ...
    public function flashsale_show() {
        ...
        foreach ($flashsale_products as $key => $value) {
             ...
             return view('frontend/flashsale/show',compact('flashsale','flashsale_products','count_flashsale'));
        }else{
             return view('frontend/flashsale/show',compact('flashsale','count_flashsale'));
        }
    }
