...
<div class="content">
    ...
    <form action="{!!route('admin.benefit.update',['id'=>$benefit->id])!!}" method="POST" enctype="multipart/form-data">
        <div class="card">
                ...
                <div class="tab-content">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="name" value="{!!is_null(old('name'))?$benefit->name:old('name')!!}" >
                           ...
                           <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <img src="{{url('upload/config/'.$benefit->image)}}" style="height: 170px; width: 200px;" class="img-thumbnail" id="image1">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea class="form-control ckeditor" id="description" name="description">{!!is_null(old('description'))?$benefit->description:old('description')!!}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea class="form-control ckeditor" id="content" name="content">{!!is_null(old('content'))?$benefit->content:old('content')!!}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" name="order" class="form-control touchspin text-center" value="{!!is_null(old('order'))?$benefit->order:old('order')!!}">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-center">
                            <a type="button" href="{{route('admin.benefit.index')}}" class="btn btn-secondary legitRipple">Hủy</a>
