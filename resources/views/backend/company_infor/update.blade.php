...
<div class="content">
    ...
    <form action="{!!route('admin.company_infor.update',['id'=>$company_infor->id])!!}" method="POST" enctype="multipart/form-data">
        <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <input type="hidden" name="_token" value="{!! csrf_token() !!}" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="name" value="{!!is_null(old('name'))?$company_infor->name:old('name')!!}" >
                            ...
                            <div class="col-md-10">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="link" value="{!!is_null(old('link'))?$company_infor->link:old('link')!!}" >
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" name="order" class="form-control touchspin text-center" value="{!!is_null(old('order'))?$company_infor->order:old('order')!!}">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-center">
                            <a type="button" href="{{route('admin.company_infor.index')}}" class="btn btn-secondary legitRipple">Hủy</a>
