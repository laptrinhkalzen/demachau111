...
<!--                             <div class="form-group row">
                                <label class="col-md-3 col-form-label text-right">Tiêu đề tiếng Anh <span class="text-danger">*</span></label>
                                <div class="col-md-9">
...
<!--                             <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label text-right">Mô tả tiếng Anh</label>
                                <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-check col-md-3 form-check-right">
                                <label class="form-check-label float-right">
                                    Hiển thị trang chủ
                                    <input type="checkbox" class="form-check-input-styled" name="is_home" data-fouc>
                                </label>
                            </div>
                        </div>
                    </fieldset>
