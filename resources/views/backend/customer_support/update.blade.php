...
<div class="content">
    ...
    <form action="{!!route('admin.customer_support.update',['id'=>$customer_support->id])!!}" method="POST" enctype="multipart/form-data">
        <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <input type="hidden" name="_token" value="{!! csrf_token() !!}" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="name" value="{!!is_null(old('name'))?$customer_support->name:old('name')!!}" >
                            ...
                            <div class="col-md-10">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="link" value="{!!is_null(old('link'))?$customer_support->link:old('link')!!}" >
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" name="order" class="form-control touchspin text-center" value="{!!is_null(old('order'))?$customer_support->order:old('order')!!}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-10">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea class="form-control ckeditor" id="content" name="content">{!!is_null(old('content'))?$customer_support->content:old('content')!!}</textarea>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-center">
                            <a type="button" href="{{route('admin.customer_support.index')}}" class="btn btn-secondary legitRipple">Hủy</a>
