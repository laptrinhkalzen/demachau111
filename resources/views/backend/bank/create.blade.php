                ...
                <div class="tab-content">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <input type="hidden" name="_token" value="{!! csrf_token() !!}" />
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2 col-form-label text-right">Tên ngân hàng: <span class="text-danger">*</span></label>
                                        <div class="col-md-10">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <img style="height: 170px; width: 200px;" class="img-thumbnail" id="image1">
                                             <input name="images" type="file" required=""  onchange="showPreview(event);">
                            ...
                            <div class="col-md-10">
                                <input type="hidden" name="_token" value="{!! csrf_token() !!}" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" required="" name="host_name" value="{!!old('host_name')!!}" >
                            ...
                            <div class="col-md-10">
                                <input type="hidden" name="_token" value="{!! csrf_token() !!}" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" required="" name="branch" value="{!!old('branch')!!}" >
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-2 col-form-label text-right">Nội dung chuyển khoản: </label>
                                    <div class="col-md-10">
