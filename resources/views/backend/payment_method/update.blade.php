...
<div class="content">
    ...
    <form action="{!!route('admin.payment_method.update',['id'=>$payment_method->id])!!}" method="POST" enctype="multipart/form-data">
        <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <input type="hidden" name="_token" value="{!! csrf_token() !!}" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="name" value="{!!is_null(old('name'))?$payment_method->name:old('name')!!}" >
                               ...
                               <div class="col-md-10">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <img src="{{url('upload/config/'.$payment_method->image)}}" style="height: 170px; width: 200px;" class="img-thumbnail" id="image1">
                            ...
                            <div class="col-md-10">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="link" value="{!!is_null(old('link'))?$payment_method->link:old('link')!!}" >
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" name="order" class="form-control touchspin text-center" value="{!!is_null(old('order'))?$payment_method->order:old('order')!!}">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-center">
                            <a type="button" href="{{route('admin.payment_method.index')}}" class="btn btn-secondary legitRipple">Hủy</a>
