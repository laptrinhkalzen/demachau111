...
<section class="container hero-slider" >
    ...
    <div class=" single-slider">
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="">
                    <img src="https://demachau.com/wp-content/uploads/2020/10/slide-02.jpg" alt="#" style="object-fit: cover;">
                </div>
            </div>
        </div>
    </div>
...
<section class="container" style="margin-top: 10px;">
    <div>
        <div class="row">
            <div class="col-3 col-lg-3 banner-slide">
                <div class="" style="padding-left: 15px;background-color: #c70000;color: white;">
                    <img src="https://demxanh.com/template/default/images/icon_deal.png" alt="#" style="height: 100%;object-fit: cover;">
                    <div class="ux-timer">
                        <span style="font-size: 20px;">Còn lại
                            <strong id="day"></strong>&nbspngày
                        </span>
                        <div class="row container">
                            <div class="col-lg-3" style="border-style: solid;border-color: white;padding: 10px;border-radius: 5px;border-width: 2px;text-align: center;margin-right: 10px;font-size: 24px;">
                                <span>
                            ...
                            <div class="col-lg-3" style="border-style: solid;border-color: white;padding: 10px;border-radius: 5px;border-width: 2px;text-align: center;font-size: 24px;">
                                <span>
                        ...
                        <div class="row container">
                            <div class="col-lg-3" style="text-align: center;">Giờ</div>
                            <div class="col-lg-3" style="text-align: center;">Phút</div>
                            <div class="col-lg-3" style="text-align: center;">Giây</div>
                        </div>
                    </div>
                </div>
            </div>
