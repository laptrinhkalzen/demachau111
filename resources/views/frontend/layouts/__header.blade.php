                        ...
                        <div class="col-lg-3">
                            <div class="all-category">
                                ...
                                <ul class="main-category">
                                    ...
                                    <li><a href="#">{!!$cat->title!!} <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                        <ul class="sub-category">
                                            @if(!is_null($cat->children))
                                            
                                            @foreach ($cat->children as $key=>$cat1)
                                            @if($cat1)
                                            <li class=""><a  class="dropdown-item " href="" data-url="/san-tre-ali"> <img src="" class="img-fluid mr-2 "/>{!!$cat1->title!!}</a>
