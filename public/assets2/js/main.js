...
(function($) {
    ...
    if ( _mainJS ) {
        ...
        if ( document.querySelector('[data-animeJS]') ) {
            ...
            anime_js.src = 'assets2/plugins/lib/anime/anime.min.js';
        ...
        if ( document.querySelector('[data-parallax]') ) {
            ...
            parallax_js.src = 'assets2/plugins/parallax/parallax.js';
        ...
        if ( document.querySelector('[data-aos]') ) {
            ...
            aos_js.src = 'assets2/plugins/aos/aos.js';
        ...
        if ( document.querySelector('[data-scrollbar]') ) {
            ...
            nicescroll_js.src = 'assets2/plugins/scrollbar/jquery.nicescroll.min.js';
...
$('a[data-action ="incre-to-cart"]').click(function(){
     var product_id=$(this).data('product_id');
     var quantity=-1;
     $.ajax({
            url:'/api/add-to-cart',
...
$('a[data-action ="decre-to-cart"]').click(function(){
     var product_id=$(this).data('product_id');
     var quantity=1;
     $.ajax({
            url:'/api/add-to-cart',
...
$('a[data-action ="save-to-cart"]').click(function(){
     var product_id=$(this).data('product_id');
     var quantity=1;
     $.ajax({
            url:'/api/add-to-cart',
